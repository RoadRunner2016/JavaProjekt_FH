...
public class Material {
    ...
    public void setMaterialID(Integer _materialID) {
    ...
    public void setMaterialPrice(Double _materialPrice) {
        this.materialPrice = _materialPrice;
    }

    public void setMaterialAmount(Integer _materialAmount) {
